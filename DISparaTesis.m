function [ddISsB,dIS,dISx,dISy,ddIS,dISMX,dISMY,r,c,dxIS,dyIS,nfd,ncd]=DISparaTesis                       
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%     Densidad construída a partir de la imagen satelital
load('Datacn1.mat');
load('PuntosDistribucionInicialEjemplo2.mat');                                                       % this files contains the initial dataset of the bathymetry H                  
...
hold off
%%% distribucion inicial en contorno lago malla satelital
figure(4000) 
contour(dxIS,dyIS,dIS,'k');
hold on
for i=1:length(ddISsB(:,1))
    plot(DIXLHM1P*ddISsB(i,2),DIYLHM1P*ddISsB(i,1),'r');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% figure(200)
% surf(dxIS,dyIS,dIS)                                                        % gráfico de la densidad
% shading interp 
% title('densidad generada a partir de la Imagen Satelital') 
% figure(400) 
% contour(dxIS,dyIS,dIS,'k');
% hold on
% for i=1:length(ddISsB(:,1))
%     plot(DXIS*ddISsB(i,2),DYIS*ddISsB(i,1),'r');
% end
...
%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ZI=griddata(ddISsB(:,1),ddISsB(:,2),ddISsB(:,3),ddISsB(:,1),ddISsB(:,2));
figure(5500) 
contour(dxIS,dyIS,dIS,'k');
hold on
surf(ddISsB(:,1),ddISsB(:,2),ZI,'r');
shading interp
title('Puntos sobre el lago donde se registro clorofila sin incluir el borde del lago')
hold off
